          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="row g-xxl-5 g-4">
                {items.map((item, i) => (
                  <div key={unique_id} class="col-xl-3 col-lg-4 col-sm-6">
                    <div key={unique_id} class="feature-box">
                      <div key={unique_id} class="feature-top">
                        <div key={unique_id} class="feature-icon">
                          {item.icons.map((el, i) => (
                            <img
                              key={i}
                        ...
                        <h3 key={unique_id}>{item.title}</h3>
                      </div>
                      <h4 key={unique_id} >{item.description}</h4>
                      <div key={unique_id} data-cursor="pointer" class="link-overflow">
                        <a key={unique_id} href="service.html">
                          Read more
                          <BsBoxArrowRight />
                        </a>
                      </div>
